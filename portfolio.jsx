        ...
        >
          <span
            style={{
              ...
              height: 34,
              borderRadius: 10,
              background: `linear-gradient(135deg, ${C.orbit}, ${C.signal})`,
              fontFamily: FONT_DISPLAY,
              fontWeight: 700,
              fontSize: 14,
              color: C.void,
          ...
          <span style={{ fontFamily: FONT_MONO, fontSize: 12, color: C.haze, letterSpacing: "0.08em", textTransform: "uppercase" }}>
            Portfolio
          </span>
        </a>
      ...
      >
        ...
        <div
          style={{
            position: "absolute",
            inset: 0,
            background: "linear-gradient(180deg, rgba(2,3,4,0.70) 0%, rgba(2,3,4,0.35) 40%, rgba(2,3,4,0.55) 70%, rgba(2,3,4,0.92) 100%)",
          }}
        />
        <div
          style={{
